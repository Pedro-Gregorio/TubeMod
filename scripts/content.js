...
const getDefaultElements = () => [
  ...
  },
  {
    id: "shorts",
    selector:
      "//ytd-guide-entry-renderer[a[@title='YouTube Shorts']] | //ytd-mini-guide-entry-renderer[a[@title='YouTube Shorts']] |//ytd-guide-entry-renderer[a[@title='Shorts']] | //ytd-mini-guide-entry-renderer[a[@title='Shorts']]",
    hidden: false,
    category: "Sidebar",
  },
  {
